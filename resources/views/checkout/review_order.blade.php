                        ...
                        <div class="table-responsive cart_info">
                            <table class="table table-condensed">
                                ...
                                @foreach($cart_datas as $cart_data)
                                    ...
                                    <td class="cart_price">
                                        <p>DA{{$cart_data->price}}</p>
                                    </td>
                                    <td class="cart_quantity">
                                        <p>{{$cart_data->quantity}}</p>
                                    </td>
                                    <td class="cart_total">
                                        <p class="cart_total_price">DA{{$cart_data->price*$cart_data->quantity}}</p>
                                    </td>
                                </tr>
                                @endforeach
                                <tr>
                                        ...
                                        <table class="table table-condensed total-result">
                                            ...
                                            @if(Session::has('discount_amount_price'))
                                                <tr class="shipping-cost">
                                                    ...
                                                    <td>DA{{Session::get('discount_amount_price')}}</td>
                                                </tr>
                                                <tr>
                                                    <td>Total</td>
                                                    <td><span>DA {{$total_price-Session::get('discount_amount_price')}}</span></td>
                                                </tr>
                                            @else
                                                <tr>
                                                    <td>Total</td>
                                                    <td><span>DA {{$total_price}}</span></td>
                                                </tr>
                                            @endif
                                        </table>
                                    </td>
