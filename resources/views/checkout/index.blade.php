...
@section('content')
    <div class="container">
        ...
        @endif
        <h1 style="font-size: 60px;">Formulaire de commande</h1>
        <br>
        <div class="row">
            <form action="{{url('/submit-checkout')}}" method="post" class="form-horizontal">
                <div class="col-sm-4 col-sm-offset-1">
                    <div class="login-form"><!--login form-->
                        ...
                        <span>
                            <input type="checkbox" class="checkbox" name="checkme" id="checkme">Expédition à
                        </span>
                    </div><!--/login form-->
                </div>
                <div class="col-sm-1">
